...
if is_directory "${PERSONAL_PROFILES_DIR}/FirefoxProfile/Profiles"; then
  section_header 'Update betterfox user.js'
  curl -fsSL https://raw.githubusercontent.com/yokoffing/Betterfox/main/user.js -o "${PERSONAL_PROFILES_DIR}/FirefoxProfile/Profiles/user.js"
fi
