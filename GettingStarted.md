...
```zsh
export GH_USERNAME='jotheeswaran-dev' DOTFILES_BRANCH='master' FIRST_INSTALL='true'; curl --retry 5 --retry-delay 10 --retry-max-time 120 --max-time 150 --connect-timeout 30 --retry-connrefused -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh; unset FIRST_INSTALL
```
